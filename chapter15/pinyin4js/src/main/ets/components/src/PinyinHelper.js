...
export class PinyinHelper {
    ...
    static _convertWithToneNumber(str) {
        LogUtil.info(`_convertWithToneNumber, str: ${str}`);
    ...
    static _convertWithoutTone(str) {
        LogUtil.info(`_convertWithoutTone, str: ${str}`);
        var pinyinArray;
    ...
    static _formatPinyin(str, format) {
        LogUtil.info(`_formatPinyin, str: ${str}`);
    ...
    static _convertToPinyinArray(c, format) {
        LogUtil.info(`_convertToPinyinArray, c: ${c}`);
    ...
    static _getWords(str) {
        LogUtil.info(`_getWords, str: ${str}`);
        for(var i = 1; i < 6; i++) {
    ...
    static convertToPinyinString(str, separator, format) {
        LogUtil.info(`convertToPinyinString, str: ${str}`);
        var result = ['']
        var pos = 0
    ...
    static getShortPinyin(str) {
        LogUtil.info(`getShortPinyin, str: ${str}`);
    ...
    static hasMultiPinyin(c) {
        LogUtil.info(`hasMultiPinyin, c: ${c}`);
        var pinyin = PINYIN_TABLE[c];
